...
const FULL_COMBO_TYPE_STRING = {};
FULL_COMBO_TYPE_STRING[CLEAR_TYPE.NO_PLAY]      = "NoPlay";
FULL_COMBO_TYPE_STRING[CLEAR_TYPE.FAILED]       = "Failed";
FULL_COMBO_TYPE_STRING[CLEAR_TYPE.ASSIST_CLEAR] = "AssistClear";
FULL_COMBO_TYPE_STRING[CLEAR_TYPE.CLEAR]        = "Clear";
FULL_COMBO_TYPE_STRING[CLEAR_TYPE.LIFE4]        = "LIFE4";
FULL_COMBO_TYPE_STRING[CLEAR_TYPE.GOOD_FC]      = "GFC";
FULL_COMBO_TYPE_STRING[CLEAR_TYPE.GREAT_FC]     = "FC";
FULL_COMBO_TYPE_STRING[CLEAR_TYPE.PERFECT_FC]   = "PFC";
FULL_COMBO_TYPE_STRING[CLEAR_TYPE.MARVELOUS_FC] = "MFC";
